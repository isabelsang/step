...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeCannotAttend() {
    // Have each person have different events and one optional person has an event all day
    // We should still see three options because the optional person is unable to attend
  ...
  public void optionalAttendeeCanAttend() {
    // Have each person have different events and one optional person with an event.
    // We should see two options because the optional person is able to attend the meeting
  ...
  public void notEnoughRoomWithOptional() {
    // Have one person, who has just enough room at one point in the day to have the meeting.
    // Have optional person that has a meeting that if taken into account, would result in 
    // a time slot smaller than the requested time.  Optional person should be ignored
    //
    // Events  :  |--A--||B|  |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  @Test
  public void onlyOptionalAttendeesWithAvailGaps() {
  ...
  @Test
  public void onlyOptionalAttendeesWithNoAvailGaps() {
    // Have two optional person, but make it so that there is not enough room at any point in the day to
    // have the meeting.
    //
    // Events  : |--A-----| |-----B----|
    // Day     : |---------------------|
